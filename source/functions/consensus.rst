...
ChainSQL3.0对共识模块进行了\ :ref:`抽象设计 <共识可插拔>`\ ，实现接入了多种共识算法。目前已经支持的共识算法有\ `RPCA <https://xrpl.org/consensus.html>`_\ 、\ :ref:`POP <PoP共识版本>`\ 和\ `HotStuff <https://arxiv.org/pdf/1803.05069.pdf>`_\ 。可通过节点配置文件对链使用的共识算法类型和共识参数进行配置。
